// PRESERVED v1 of the KZ university detail screen (the version saved on
// 2026-06-29 before the richer redesign).
//
// Kept verbatim except the public class name (→ `UniversityCatalogDetailScreenLegacy`)
// so we can revert at any time. To go back to this layout, point the
// `/uni-kz/:id` route in app_router.dart at `UniversityCatalogDetailScreenLegacy`
// instead of `UniversityCatalogDetailScreen`.
...
class UniversityCatalogDetailScreenLegacy extends ConsumerWidget {
  /// Creates the detail screen for [universityId].
  const UniversityCatalogDetailScreenLegacy({
